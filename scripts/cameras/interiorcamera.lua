...
InteriorCamera = Class(FollowCamera, function(self, inst)
    ...
    --(H): I'm not sure what this does.. it doesn't seem to break things when I comment it out. But it is causing 8 faced thigns to mess up.
--    self:Snap()
...
function InteriorCamera:Apply()
    ...
    if self.followPlayer then
        ...
        local target = Vector3(self.interior_currentpos.x, self.interior_currentpos.y, self.interior_currentpos.z)
